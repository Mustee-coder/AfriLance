            ...
            {user?.role === "developer" && clientId && (
              <div className="mt-6 border-t border-slate-100 pt-6">
                ...
                <button
                  ...
                  className="mt-4 flex w-full items-center gap-3 rounded-2xl border border-slate-200 bg-white p-4 text-left transition hover:border-emerald-200 hover:bg-emerald-50"
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-xs text-slate-500">
                      See company information and details
                    </p>
                  </div>
